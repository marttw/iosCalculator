...
final class HomeViewController: UIViewController {
    ...
    private var temp: Double = 0 //Valor temporal en pantalla
    private var operating = false //Indica si se seleccionó un operador
    ...
    private enum OperationType{
        case none, addition, division, substraction, multiplication, percent
